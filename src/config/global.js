  ...
  creditos: {
    ...
    contenidoInstruccional: [
      ...
      },
      {
        ...
        centro:
          'Centro agroempresarial y turístico de los Andes. Málaga (Santander)',
      },
      {
        nombre: 'Denis Omar Laguado  Jaimes',
        cargo: 'Experto disciplinar',
        centro:
          'Centro de atención al sector agropecuario. Piedecuesta (Santander)',
      },
      {
